local PANEL = {
    Init = function(self)
        ...
        label:SetText("Paul - Police Intendant");
        ...
        if LocalPlayer():Team() == TEAM_POLICE then
            ...
            spawnButton:SetText("Get Police Vehicle");
            ...
            text:SetText("To join the police, speak to the Chief");
            text:SizeToContents();
...
vgui.Register("npc_police_carspawner_panel", PANEL)